...
def get_date_range(year, semester):
    """Map semester and year to date range."""
    try:
        year = int(year)
        if semester == 1:
...
def get_classroom_requirements():
    ...
    try:
        ...
        postgres_tool = PostgresTool(host='postgres_container')
        ...
        for lecture in course_lectures:
            # Ensure 'course_id' exists in the lecture data
            ...
            # Add lecture details (convert datetime objects to strings)
        ...
        # Process student counts and schedules (rest of the code remains similar)
